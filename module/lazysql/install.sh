...
echo "[2] No Warranty"
echo "[3] If it violates the law with this tool the risk is borne by                   >
echo ""
echo "-------------------------------------------"
...
chmod 777 lazysqlmap/sqlmap.py lazysqlmap/sqlmapapi.py lazysqlmap/laz                  >
echo "creating bash command"
cp lazysqlmap/lazysqlmap /data/data/com.termux/files/usr/bin/
echo "giving access level for enabling lazysqlmap execute from termin                  >
...
echo "-----------------------------"
echo ""
echo "type lazysqlmap from your terminal command if you wanna start u                  >
echo ""
