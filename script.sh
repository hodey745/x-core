...
echo "           ║╚════════════════════════════════╝  ╚════╝║"
echo "           ║╔════════════════════════════════╗  ╔════╗$cyen║"
echo "           ║║$nol[\033[93m8\033[0m].SQLMAP (Lazy)               $cyen║  ║$nol \033[92mON\033[0m $cyen║║"
echo "           ║╚════════════════════════════════╝  ╚════╝║"
echo "           ║╔════════════════════════════════╗  ╔════╗$cyen║"
echo "           ║║$nol[\033[93m9\033[0m].SPAM WA                     $cyen║  ║$nol \033[92mON\033[0m $cyen║║"
echo "           ║╚════════════════════════════════╝  ╚════╝║"
echo "           ║╔════════════════════════════════╗  ╔════╗$cyen║"
echo "           ║║$nol[\033[93m10\033[0m].EXIT                       $cyen║  ║$nol \033[31mXX\033[0m $cyen║║"
echo "           ║╚════════════════════════════════╝  ╚════╝║"
echo "           ╚══════════════════════════════════════════╝$nol" 
echo ""
